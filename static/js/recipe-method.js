let counter2 = 2;
let limit2 = 30;
const newMethod = '<div id="methodholder*" class="input-field col s12"><i class="fas fa-wrench prefix"></i><input id="method*" type="text" name="method" minlength="3" maxlength="300" class="validate" required><label for="method*" placeholder="Step">Step *</label><a class="waves-effect waves-light btn" onClick="deleteMethod(this)" data-method="methodholder*"><i class="fas fa-times"></i> Remove</a></div>'
